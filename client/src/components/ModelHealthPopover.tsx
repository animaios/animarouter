  ...
  return (
    ...
    >
      ...
      {open && (
        <div
          role="tooltip"
          className="pointer-events-none absolute bottom-full left-1/2 z-50 mb-2 w-[260px] -translate-x-1/2 rounded-2xl border border-white/10 bg-[#0d0d0d] p-3 shadow-lg shadow-black/40"
        >
