  ...
  it("explains a non-JSON 200 body instead of surfacing the raw parse error (#189)", async () => {
    ...
    vi.spyOn(global, "fetch").mockResolvedValueOnce({
      ...
      json: () =>
        Promise.reject(
          new SyntaxError(
            "Unexpected non-whitespace character after JSON at position 583 (line 27 column 2)",
          ),
        ),
    } as any);
          ...
          choices: [
            {
              ...
              message: {
                ...
                reasoning_content: "should not override",
              },
              finish_reason: "stop",
            },
          ],
