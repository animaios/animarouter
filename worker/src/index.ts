...
export async function handleRequest(req: Request, env: Env): Promise<Response> {
  ...
  if (!isAllowedHost(upstreamUrl.hostname, env.ALLOWED_HOSTS ?? DEFAULT_ALLOWED_HOSTS)) {
...
function parseProxyPath(pathname: string): { authKey: string; version: string; encodedUpstream: string } | null {
